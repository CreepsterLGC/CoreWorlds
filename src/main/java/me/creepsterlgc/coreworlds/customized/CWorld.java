...
public class CWorld {
	...
	public CWorld(String name, boolean priv, List<String> whitelist, Difficulty difficulty, GameMode gamemode, boolean monsters, boolean animals, boolean pvp, boolean build, boolean interact, Location<World> spawn, boolean hunger, boolean invulnerability, String time, String weather, double border, double borderdamage) {
		this.name = name;
		this.priv = priv;
